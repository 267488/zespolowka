...
public class kategorieController {
     ...
     private final kategorieRepository kategorieRepository;
        ...
        public kategorieEntity updateKategorie(final @PathVariable Integer id, final @RequestBody @Valid kategorieCmd updatedKategorie, final BindingResult bindingResult) {
            ...
            kategorie.setName(updatedKategorie.getName());
    ...
    @RequestMapping(value = "/kategorie/{id}", method = DELETE)
    @PreAuthorize("isAuthenticated()")
    @Transactional
    public void deleteKategorie(@PathVariable Integer id, final @RequestParam(required = false, defaultValue = "false") boolean all) {

        final kategorieEntity kategorie = kategorieRepository.findById(id);
