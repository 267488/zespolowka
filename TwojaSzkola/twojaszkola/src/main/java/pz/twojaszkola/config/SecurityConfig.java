...
public class SecurityConfig {
	...
	protected void configure(final HttpSecurity http) throws Exception {	  
            http
                    ...
                    .antMatchers("/profil-szkola.html","/ustawienia-szkola.html","/szkoly1.html").hasAuthority("SZKOLA")
                    .antMatchers("/admin.html","/admin.html/*").hasAuthority("ADMIN")
                    .antMatchers("/profil-uczen.html","/ustawienia-uczen.html","/szkoly.html","/index.html").hasAuthority("UCZEN")
                    .and()
                    .formLogin()
