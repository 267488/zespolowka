...
import pz.twojaszkola.config.TrackerConfig.TrackerProperties;
import pz.twojaszkola.tracker.LocationService;
import pz.twojaszkola.tracker.NewLocationCmd;
...
public class TrackerConfig extends AbstractWebSocketMessageBrokerConfigurer {
	...
	rv.setMessageListener((MessageListener) new MessageListener() {
            @Override
            public void onMessage(Message message) {
                ...
                try {
                    ...
                    Logger.getLogger(TrackerConfig.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
