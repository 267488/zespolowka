...
public class UserController{
    ...
    public void userReg(@RequestBody UserTest usertest) throws AddressException, MessagingException{
        ...
        {
        UczenEntity uczen = new UczenEntity(null, null, null, null, null, user);
        
        uczenRepository.save(uczen);
        }
        if(usertest.getRole().equals("SZKOLA"))
        {
            SzkolaEntity szkola = new SzkolaEntity(null, null, null, null, null, null, null, "glyphicon-star-empty", user);
    ...
    public SuperSzkola currentSchool()
    {
        ...
        System.out.println("current school id: "+szkola.getId());
        
        /*System.out.println(szkola.getId()+" sid");
        System.out.println(user.getLogin()+" login");
        System.out.println(user.getPassword()+" pass");
        System.out.println(user.getEmail()+" mail");
        System.out.println(szkola.getName()+" name");
        System.out.println(szkola.getNumer()+" numer");
        System.out.println(szkola.getMiasto()+" miasto");
        System.out.println(szkola.getAdres()+" adres");
        System.out.println(szkola.getKodpocztowy()+" kod");
        System.out.println(szkola.getTypSzkoly()+" typ");
        System.out.println(szkola.getRodzajSzkoly()+" rodzaj");
        System.out.println(szkola.getRodzajGwiazdki()+" gwiazda");
        System.out.println(user.getId()+" uid");
        System.out.println(szkola.getGalleryId()+" gid");*/
        
        SuperSzkola superSzkola;
        superSzkola = new SuperSzkola(szkola.getId(), 
                user.getLogin(),
                user.getPassword(),
                user.getEmail(),
                szkola.getName(),
                ...
                szkola.getRodzajGwiazdki(),
                user,
                szkola.getGalleryId());
       
        /*System.out.println("BEFORE SET");
        
        superSzkola.setId(szkola.getId());
        superSzkola.setLogin(user.getLogin());
        superSzkola.setPassword(user.getPassword());
        superSzkola.setMail(user.getEmail());
        superSzkola.setName(szkola.getName());
        superSzkola.setNumer(szkola.getNumer());
        superSzkola.setMiasto(szkola.getMiasto());
        superSzkola.setAdres(szkola.getAdres());
        superSzkola.setKodpocztowy(szkola.getKodpocztowy());
        superSzkola.setTypSzkoly(szkola.getTypSzkoly());
        superSzkola.setRodzajSzkoly(szkola.getRodzajSzkoly());
        superSzkola.setRodzajGwiazdki(szkola.getRodzajGwiazdki());
        superSzkola.setUserId(user.getId());
        superSzkola.setGalleryId(szkola.getGalleryId().getId());
