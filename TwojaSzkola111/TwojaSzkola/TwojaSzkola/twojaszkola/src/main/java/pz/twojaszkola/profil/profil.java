...
public class profil {
    ...
    private List<RozszerzonePrzedmiotyEntity> rozszerzonePrzedmioty;

    protected profil() {
    }

    public profil(ProfilEntity profilId, List<RozszerzonePrzedmiotyEntity> rozszerzonePrzedmioty) {
    ...
    public void setProfilId(ProfilEntity profilId) {
        this.profilId = profilId;
    }
