 ...
 * @author Agata
 */
public interface OcenaPrzedmiotuRepository extends JpaRepository<OcenaPrzedmiotuEntity, Integer>{
    ...
    OcenaPrzedmiotuEntity getOcenaByPrzedmiotAndProfil2(final Integer idPrzedmiotu, final Integer idProfilu);
}
